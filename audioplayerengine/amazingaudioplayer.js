    ...
    $.fn.amazingaudioplayer = function(options) {
        var PlayerSkin = function(amazingPlayer, container, options, id) {
            ...
            if (this.options.showtitle ||
                ...
                if (this.options.showtitle) {
                    ...
                    this.container.bind("amazingaudioplayer.updateinfo", function(event, data) {
                        ...
                        if (data.source.length > 0) { t = t.replace(/%AUDIO%/g, data.source[0].src);
            ...
            $play.appendTo($playpause).css({
                ...
                cursor: "pointer"
            }).hover(function() { $(this).css({ "background-position": "left bottom" }) }, function() { $(this).css({ "background-position": "left top" }) });
            ...
            $pause.appendTo($playpause).css({
                ...
                cursor: "pointer"
            }).hover(function() { $(this).css({ "background-position": "right bottom" }) }, function() { $(this).css({ "background-position": "right top" }) });
            $play.click(function() { instance.amazingPlayer.playAudio() });
            ...
            this.container.bind("amazingaudioplayer.played",
                function(event, currentItem) { $play.css({ display: "none" });
                    $pause.css({ display: "block" }) });
            this.container.bind("amazingaudioplayer.paused", function(event, currentItem) { $play.css({ display: "block" });
                $pause.css({ display: "none" }) });
            this.container.bind("amazingaudioplayer.stopped", function(event, currentItem) { $play.css({ display: "block" });
                $pause.css({ display: "none" }) });
            if (this.options.showstop) {
                ...
                $stop.appendTo($bar).css({
                    ...
                    cursor: "pointer"
                }).hover(function() { $(this).css({ "background-position": "center bottom" }) }, function() { $(this).css({ "background-position": "center top" }) });
                $stop.click(function() { instance.amazingPlayer.stopAudio() })
            }
            if (this.options.showprevnext) {
                ...
                $prev.click(function() { instance.amazingPlayer.audioRun(-2, instance.amazingPlayer.audioPlayer.isPlaying) });
                $next.click(function() {
            ...
            if (this.options.showloop) {
                ...
                $loop.appendTo($bar).css({ display: "block", width: this.options.loopimagewidth, height: this.options.loopimageheight, "background-image": 'url("' + this.options.skinsfolder + this.options.loopimage + '")', "background-repeat": "no-repeat", "background-position": backgroundPosX[this.options.loop] + " top", cursor: "pointer" }).hover(function() {
                    var backgroundPosX =
            ...
            if (this.options.showvolume && !AmazingAudioPlatforms.isIOS() && !AmazingAudioPlatforms.isAndroid()) {
                ...
                this.$volumeButton.click(function() {
                    ...
                    if (volume > 0) { instance.volumeSaved = volume;
                        volume = 0 } else volume = instance.volumeSaved;
                    var backgroundPosY = $(this).css("background-position") ? $(this).css("background-position").split(" ")[1] : $(this).css("background-position-y");
                ...
                if (this.options.showvolumebar) {
                    ...
                    this.$volumeBar.css({ display: "none", position: "absolute", left: 0, bottom: "100%", "-webkit-box-sizing": "content-box", "-moz-box-sizing": "content-box", "box-sizing": "content-box", width: this.options.volumeimagewidth - 2 * this.options.volumebarpadding, height: this.options.volumebarheight - 2 * this.options.volumebarpadding, padding: this.options.volumebarpadding });
                    ...
                    this.$volumeBarAdjustActive.css({ display: "block", position: "absolute", left: 0, bottom: 0, width: "100%", height: "100%" });
                    this.$volumeBarAdjust.bind(eStart, function(e) {
                        ...
                        function() { instance.$volumeBarAdjust.unbind(eMove) });
                    this.hideVolumeBarTimeout = null;
                    this.$volume.hover(function() { clearTimeout(instance.hideVolumeBarTimeout);
                        if (AmazingAudioPlatforms.isIE678()) instance.$volumeBar.show();
                        else instance.$volumeBar.fadeIn() }, function() { clearTimeout(instance.hideVolumeBarTimeout);
                        instance.hideVolumeBarTimeout = setTimeout(function() {
                            if (AmazingAudioPlatforms.isIE678()) instance.$volumeBar.hide();
                            else instance.$volumeBar.fadeOut() }, 1E3) })
                }
                this.container.bind("amazingaudioplayer.setvolume",
                    function(event, volume) { volume = volume > 1 ? 1 : volume < 0 ? 0 : volume;
            ...
            if (this.options.showprogress) {
                ...
                this.container.bind("amazingaudioplayer.loadprogress", function(event, progress) { $progressLoaded.css({ width: progress + "%" }) });
            ...
            if (this.options.showtracklist) {
                    ...
                    if (data.current >= 0) {
                        ...
                        if (instance.options.tracklistitem < instance.amazingPlayer.elemLength) {
                            ...
                            if (instance.tracklistPage != page) {
                                ...
                                if (instance.tracklistPage == 0) { instance.$tracklistarrowprev.hide();
                                    instance.$tracklistarrownext.show() } else if (instance.tracklistPage == instance.tracklistPageNum - 1) { instance.$tracklistarrowprev.show();
                                    instance.$tracklistarrownext.hide() } else {
                ...
                for (var i = 0; i < this.amazingPlayer.elemLength; i++) {
                    ...
                    $track.hover(function() { $(this).addClass("amazingaudioplayer-track-item-active");
                        if ($(this).data("order") != instance.amazingPlayer.currentItem) $(this).addClass("amazingaudioplayer-track-item-hoverover") }, function() {
                ...
                if (this.options.tracklistitem < this.amazingPlayer.elemLength) {
                    ...
                    this.$tracklistarrowprev.click(function() {
                        ...
                        if (instance.tracklistPage <= 0) { instance.tracklistPage = 0;
                            instance.$tracklistarrowprev.hide() }
                        instance.$tracklistarrownext.show();
                        var t = -instance.tracklistPage * instance.tracklistItemHeight * instance.options.tracklistitem;
                        instance.$tracks.animate({ top: t })
                    });
                    this.$tracklistarrownext.click(function() { instance.tracklistPage++;
                        if (instance.tracklistPage >= instance.tracklistPageNum - 1) { instance.tracklistPage = instance.tracklistPageNum - 1;
        ...
        FlashHTML5Player.prototype = {
            initFlash: function() {
                ...
                window.AmazingSWFObject.embedSWF(this.flashPlayerEngine, objectId, "1", "1", "9.0.0", false, { playerid: this.id }, { wmode: "transparent", allowscriptaccess: "always", allownetworking: "all" }, {});
            ...
            initHtml5: function() {
                ...
                var instance = this;
                html5Audio.addEventListener("ended", function() { instance.amazingPlayer.onAudioEnded() });
                html5Audio.addEventListener("timeupdate", function() { instance.amazingPlayer.playProgress(html5Audio.currentTime * 1E3, html5Audio.duration * 1E3) });
            ...
            load: function(audioItem) {
                ...
                if (!AmazingAudioPlatforms.isIE6789())
                    for (i = 0; i < audioSource.length; i++)
                        if (audioSource[i].type == "audio/mpeg" && this.supportMp3 || audioSource[i].type == "audio/ogg" && this.supportOgg) { this.isHtml5 = true;
                            break }
            ...
            flashLoadAudio: function(mp3Src, playAudio) {
                ...
                if (!AmazingFlashAudioPlayerReady[this.id]) { this.loadFlashTimeout += 100;
                    if (this.loadFlashTimeout < 6E3) { setTimeout(function() { instance.flashLoadAudio(mp3Src, playAudio) }, 100);
                        return } } else {
            ...
            play: function() {
                if (this.isHtml5) {
                    ...
                    this.html5Object.get(0).play() } else if (this.flashAudioLoadedSucceed) this.flashObject.playAudio();
            ...
            stop: function() {
                if (this.isHtml5) { this.html5Object.get(0).pause();
                    this.html5Object.get(0).currentTime = 0 } else this.flashObject.stopAudio();
                this.isPlaying = false },
        ...
        AmazingAudioPlayer.prototype = {
            ...
            init: function(instance) {
                ...
                if (instance.options.autoplay && !AmazingAudioPlatforms.isIOS() && !AmazingAudioPlatforms.isAndroid()) window.setTimeout(function() { instance.playAudio() }, instance.options.autoplaytimeout);
            ...
            createSkin: function() { new PlayerSkin(this, this.container, this.options, this.id) },
            getParams: function() {
                var result = {};
            ...
            pauseAudio: function() { this.audioPlayer.pause();
                this.container.trigger("amazingaudioplayer.paused", this.currentItem) },
            stopAudio: function() { this.audioPlayer.stop();
                this.container.trigger("amazingaudioplayer.stopped", this.currentItem);
                this.container.trigger("amazingaudioplayer.playprogress", { current: 0, duration: 0, live: this.elemArray[this.currentItem].live }) },
            setVolume: function(volume) {
                this.audioPlayer.setVolume(volume);
                this.container.trigger("amazingaudioplayer.setvolume", volume)
            },
            loadProgress: function(progress) { this.container.trigger("amazingaudioplayer.loadprogress", progress) },
            playProgress: function(current, duration) {
                ...
                this.container.trigger("amazingaudioplayer.playprogress", { current: current, duration: d0, live: this.elemArray[this.currentItem].live }) },
            setTime: function(pos) { this.audioPlayer.setTime(pos, this.elemArray[this.currentItem].duration) }
        };
        ...
        this.each(function() {
            ...
            if ($("div#amazingaudioplayer_options").length) $.each($("div#amazingaudioplayer_options").data(), function(key, value) { instance.options[key.toLowerCase()] = value });
            var searchoptions = {};
            ...
            else { audioplayerid = amazingaudioplayerId;
...
if (typeof AmazingFlashAudioPlayerReady === "undefined") {
    ...
    function onAmazingFlashAudioPlayerReady(playerid) { AmazingFlashAudioPlayerReady[playerid] = true }

    function amazingFlashAudioPlayerEventHandler(event, playerid, param, param1) {
        var id = playerid;
        for (var i = 0; i < amazingAudioPlayerObjects.objects.length; i++)
            if (amazingAudioPlayerObjects.objects[i].id == playerid) { id = i;
                break }
        switch (event) {
            case "completed":
...
function AmazingSWFObjectFunc() {
    var UNDEF = "undefined",
        ...
        ua = function() {
            ...
            if (typeof nav.plugins != UNDEF && typeof nav.plugins[SHOCKWAVE_FLASH] ==
                OBJECT) { d = nav.plugins[SHOCKWAVE_FLASH].description;
                if (d && !(typeof nav.mimeTypes != UNDEF && nav.mimeTypes[FLASH_MIME_TYPE] && !nav.mimeTypes[FLASH_MIME_TYPE].enabledPlugin)) { plugin = true;
                    ...
                    playerVersion[2] = /[a-zA-Z]/.test(d) ? parseInt(d.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0 } } else if (typeof win.ActiveXObject != UNDEF) try {
        ...
        onDomLoad = function() {
            ...
            if (!isDomLoaded) {
                ...
                if (ua.ie && ua.win) { doc.attachEvent(ON_READY_STATE_CHANGE, function() {
                        if (doc.readyState == "complete") { doc.detachEvent(ON_READY_STATE_CHANGE, arguments.callee);
                            callDomLoadFunctions() } });
                    if (win == top)(function() {
                        if (isDomLoaded) return;
                        try { doc.documentElement.doScroll("left") } catch (e) { setTimeout(arguments.callee, 0);
                            return }
                        callDomLoadFunctions() })() }
                if (ua.wk)(function() {
                    if (isDomLoaded) return;
            ...
            (function() {
                if (typeof t.GetVariable !=
                    ...
                    if (d) { d = d.split(" ")[1].split(",");
                        ua.pv = [parseInt(d[0], 10), parseInt(d[1], 10), parseInt(d[2], 10)] } } else if (counter < 10) { counter++;
                ...
                if (ua.pv[0] > 0) {
                    ...
                    if (obj)
                        if (hasPlayerVersion(regObjArr[i].swfVersion) &&
                            !(ua.wk && ua.wk < 312)) { setVisibility(id, true);
                            if (cb) { cbObj.success = true;
                                cbObj.ref = getObjectById(id);
                                cb(cbObj) } } else if (regObjArr[i].expressInstall && canExpressInstall()) {
                        var att = {};
    ...
    function showExpressInstall(att, par, replaceElemIdStr, callbackFn) {
        ...
        if (obj) {
            if (obj.nodeName == "OBJECT") { storedAltContent = abstractAltContent(obj);
                storedAltContentId = null } else {
                storedAltContent =
                    obj;
    ...
    function getElementById(id) {
        var el = null;
        try { el = doc.getElementById(id) } catch (e) {}
        return el }
    ...
    function createCSS(sel, decl, media, newStyle) {
        ...
        if (ua.ie && ua.win) {
            if (dynamicStylesheet && typeof dynamicStylesheet.addRule == OBJECT) dynamicStylesheet.addRule(sel, decl) } else if (dynamicStylesheet && typeof doc.createTextNode != UNDEF) dynamicStylesheet.appendChild(doc.createTextNode(sel + " {" + decl + "}"))
    }
            ...
            if (ua.w3 && !(ua.wk && ua.wk < 312) && swfUrlStr && replaceElemIdStr && widthStr && heightStr && swfVersionStr) {
                ...
                addDomLoadEvent(function() {
                    ...
                    if (hasPlayerVersion(swfVersionStr)) {
                        ...
                        return } else setVisibility(replaceElemIdStr, true);
